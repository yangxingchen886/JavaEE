    ...
    <div class="sou">
        ...
        <span class="fr">
            ...
            <% Object object = session.getAttribute("user");
                ...
                out.print("欢迎，" + "<a href=\"member_user.jsp\">" + user.getLoginName() + "</a>");%>&nbsp;|&nbsp;<a
                          href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
        ...
        <div class="i_car">
            ...
            <div class="car_bg">
                ...
                <ul class="cars">
                    ...
                    <li>
                        <div class="img"><a href="#"><img src="images/car2.jpg" width="58"
                                                          height="58"/></a></div>
                ...
                <div class="price_sum">共计&nbsp; <font color="#ff4e00">￥</font><span>1058</span>
                </div>
    ...
    <div class="m_content">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    <li><a href="memOrder.do?userId=<%=user.getId()%>" >我的订单</a></li>
            ...
            <div class="m_des">
                <table border="0" style="width:870px; line-height:22px;" cellspacing="0"
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <div class="m_user"><% out.print(user.getUserName());%></div>
                            <p>
                                等级：注册用户 <br/>
